...
import com.zyt.entity.KbChunk;
import com.zyt.entity.KbDocument;
import com.zyt.entity.KnowledgeBase;
...
import com.zyt.service.impl.RagServiceImpl;
...
class RagServiceImplTest {
    ...
    void setUp() {
        ...
        dev.langchain4j.store.embedding.EmbeddingSearchResult<TextSegment> emptyResult =
    ...
    class KnowledgeBaseCrud {
        ...
        void shouldRejectEmptyName() {
            assertThrows(BadRequestException.class, () ->
                    ragService.createKnowledgeBase(TEST_EMAIL, "", "描述"));
            assertThrows(BadRequestException.class, () ->
                    ragService.createKnowledgeBase(TEST_EMAIL, null, "描述"));
        }
        ...
        void shouldRejectLongName() {
            ...
            assertThrows(BadRequestException.class, () ->
                    ragService.createKnowledgeBase(TEST_EMAIL, longName, ""));
        }
        ...
        void shouldRejectOtherUserKb() {
            ...
            assertThrows(ForbiddenException.class, () ->
                    ragService.getKnowledgeBase(TEST_EMAIL, 1L));
        }
        ...
        void shouldRejectNonExistentKb() {
            ...
            assertThrows(NotFoundException.class, () ->
                    ragService.getKnowledgeBase(TEST_EMAIL, 99L));
        }
    }
    ...
    class DocumentManagement {
        ...
        void shouldRejectNonExistentDoc() {
            ...
            assertThrows(NotFoundException.class, () ->
                    ragService.deleteDocument(TEST_EMAIL, 1L, 99L));
        }
    }

...
import com.zyt.mapper.KbChunkMapper;
import com.zyt.mapper.KbDocumentMapper;
import com.zyt.mapper.KnowledgeBaseMapper;
import com.zyt.service.RagProcessingService;
import com.zyt.utils.TextSplitterUtil;
                ...
                for (KbChunk chunk : chunks) {
                    try {
                        dev.langchain4j.data.embedding.Embedding embedding =
                                embeddingModel.embed(chunk.getContent()).content();
    ...
    public void processDocument(Long documentId) {
        ...
        try {
            ...
            for (String chunkText : chunkTexts) {
                ...
                try {
                    dev.langchain4j.data.embedding.Embedding embedding =
                            embeddingModel.embed(chunkText).content();
